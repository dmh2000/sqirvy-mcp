...
- **Let the developer specify the directory for the tests**
- **Include tests for expected use, edge cases and failure cases**
- **Use the standard golang`test` for unit tests**
...
- **when the language is Go**
  - **Use gofmt" for formatting**
  - **Use `staticcheck` for code linting**.
  - Write **Go doc comments for packages, funcs and types** using the Google Go styles
